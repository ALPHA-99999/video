...
namespace {
struct qt_meta_tag_ZN17MqttFrameReceiverE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17MqttFrameReceiverE = QtMocHelpers::stringData(
    "MqttFrameReceiver",
    "frame_toproess",
    "",
    "frameData",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17MqttFrameReceiverE[] = {
...
Q_CONSTINIT const QMetaObject MqttFrameReceiver::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ZN17MqttFrameReceiverE.offsetsAndSizes,
    qt_meta_data_ZN17MqttFrameReceiverE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17MqttFrameReceiverE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MqttFrameReceiver, std::true_type>,
...
void MqttFrameReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MqttFrameReceiver::*)(QByteArray , qint64 , qint64 );
            if (_q_method_type _q_method = &MqttFrameReceiver::frame_toproess; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MqttFrameReceiver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17MqttFrameReceiverE.stringdata0))
